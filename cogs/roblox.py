...
class RobloxCommands(commands.Cog):
    ...
    @nextcord.slash_command(name="finduser", description="Look up a user from roblox with their username",
                            guild_ids=[testServerId])  # Rememberrr
    ...
    async def setrank(self, interaction: Interaction, username: nextcord.Member, rank: int = SlashOption(
        ...
        choices={"Legatus": 16, "Laticlavius": 15, "Praefectus": 14, "Tribunus": 13, "Centurio": 12, "Optio": 10,
                 "Salarius": 9, "Triplicarius": 8, "Duplicarius": 7, "Sesquiplicarius": 6, "Immunis": 4, "Discens": 3,
                 "Miles": 2, "Tiro": 1}
    )):
        try:
